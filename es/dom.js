...
export function createSubstance(isVertical, element) {
...
export function createBackdrop(background, element) {
...
export function createIndicator(isVertical, hasIndicator, element) {
  let indicator = null;
  if (hasIndicator) {
...
export function createItemIndicator(isVertical, element) {
  let item = null;
  if (element) {
...
export function createItemWrapper(isFirst, isVertical, hasLoading, itemGap, element) {
...
export function createLoading(element) {
...
export function createError(element) {
