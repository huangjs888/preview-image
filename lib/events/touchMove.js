...
function touchMove(e) {
  ...
  if (this instanceof _gallery.default) {
    ...
    if (entity) {
      ...
      if (this._moveTarget === 'none') {
        ...
        if (oneFinger) {
          ...
          if (this._direction === 'vertical') {
            if (this._events && typeof this._events.downSwipe === 'function' && tx >= xRange[1] && rightDown) {
            ...
            if (this._events && typeof this._events.downSwipe === 'function' && ty >= yRange[1] && rightDown) {
              this._moveTarget = 'closures';
            } else {
      ...
      if (this._moveTarget === 'none') {
        this._moveTarget = this._events && typeof this._events.downSwipe === 'function' && isRightDown(this._direction, movePoint, endPoint) ? 'closures' : 'outside';
      }
    }
